...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'btn.start': { en: 'Start Free — 10 min', zh: '免费开始——10分钟' },
  ...
  'paywall.title': { en: 'Get All 14 Lessons', zh: '获取全部14课' },
  'paywall.desc': { en: "You finished the free lessons! Get the full course — 14 lessons + a capstone project you can show employers.", zh: '你已完成免费课程！获取完整课程——14节课+可以展示给雇主的毕业项目。' },
  'paywall.coming': { en: 'Coming soon! Leave your email for early access.', zh: '即将推出！留下邮箱获取抢先体验。' },
  'paywall.contact': { en: 'Get Early Access', zh: '获取抢先体验' },
  ...
  'celebration.keep': { en: 'Keep going, you\'re doing great!', zh: '继续加油，你做得太棒了！' },
